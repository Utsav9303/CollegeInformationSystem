...
$sql = "SELECT * FROM faculty_civil";
$all_faculty_civil = $conn->query($sql);
...
<div class="body">
    ...
    <main>
        ...
        while ($row = mysqli_fetch_assoc($all_faculty_civil)) {
        ...
        ?>
            <div class="card">
                ...
                <div class="caption">
                    ...
                    <form action="CivilFaculty.php" method="POST">
                        <a href="Civildetails.php?id=<?php echo $row['id'] ?>" class="button">More Info.</a>
                    </form>
                </div>
            </div>
        <?php
