...
$sql = "SELECT * FROM faculty_mech";
$all_faculty_mech = $conn->query($sql);
...
<?php
    ...
    ?>
    <div class="body">
            <h1>Mechanical Faculty</h1>
    </div>
    <div class="body">
    <main>
        <?php

        while ($row = mysqli_fetch_assoc($all_faculty_mech)) {
        ...
        ?>
            <div class="card">
                ...
                <div class="caption">
                    ...
                    <form action="MechanicalFaculty.php" method="POST">
                        <a href="Mechanicaldetails.php?id=<?php echo $row['id'] ?>" class="button">More Info.</a>
                    </form>
                </div>
            </div>
        <?php
