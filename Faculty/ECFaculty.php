<?php
   ...
   $sql = "SELECT * FROM faculty_ec";
   $all_faculty_ec = $conn->query($sql);
...
<?php
    ...
    ?>
    <div class="body">
            <h1>Elecronics & Communicatiion Faculty</h1>
    </div>
    <div class="body">
    <main>
        <?php
        
            while($row = mysqli_fetch_assoc($all_faculty_ec)){
        ...
        <div class="card">
            ...
            <div class="caption">
                ...
                <form action="ECFaculty.php" method="POST">
                        <a href="ECdetails.php?id=<?php echo $row['id'] ?>" class="button">More Info.</a>
                    </form>
            </div>
        </div>
        <?php
