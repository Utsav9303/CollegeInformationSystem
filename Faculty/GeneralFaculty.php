<?php
   ...
   $sql = "SELECT * FROM faculty_general";
   $all_faculty_general = $conn->query($sql);
?>
<!DOCTYPE html>
<html lang="en">
...
<?php
    ...
    ?>
    <div class="body">
            <h1>General Faculty</h1>
    </div>
    <div class="body">
    <main>
        <?php
        
            while($row = mysqli_fetch_assoc($all_faculty_general)){
        ...
        <div class="card">
            ...
            <div class="caption">
                ...
                <form action="GeneralFaculty.php" method="POST">
                        <a href="Generaldetails.php?id=<?php echo $row['id'] ?>" class="button">More Info.</a>
                    </form>
            </div>
        </div>
        <?php
