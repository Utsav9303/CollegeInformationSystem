        ...
        ?>
            <div class="card">
                ...
                <div class="caption">
                    ...
                    <form action="ElectricalFaculty.php" method="POST">
                        <a href="Electricaldetails.php?id=<?php echo $row['id'] ?>" class="button">More Info.</a>
                    </form>
                </div>
            </div>
        <?php
