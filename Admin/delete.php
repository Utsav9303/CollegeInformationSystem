<?php
   ...
   $id=$_REQUEST['id'];
   $result=mysqli_query($join,"SELECT * FROM student_info WHERE id='$id' ");
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Delete Account</h3></div>
                                    <div class="card-body">
                                        
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" name="firstname" value="<?php echo $rows['name'];?>"/>
                        ...
                        <div class="category">
                            ...
                            <label for="dot-3">
                                ...
                                <!--span class="gender">Prefer not to say</!--span--> 
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input type="submit" name="submit" value="Delete" class="btn btn-primary btn-block"></div>
                                            </div>
