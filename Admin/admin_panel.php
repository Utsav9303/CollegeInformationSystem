...
$email_user_admin = $_SESSION['email_user'];
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="adminprofile.php">Profile </a><?php echo $email_user_admin;?></a></a></li>
                        <!-- <li><a class="dropdown-item" href="adminprofile.php?id=<//?php echo $rows['id'];?>">Profile</a></li> -->
                        <input name="id" type="hidden" id="id"; value="<?php echo $rows['id'];?>">
                        <li><a href="adminprofile.php?id=<?php echo $rows['id'];?>"></a></li>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="loginad_admin.php">Login</a>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="registration.php">Add</a>
                            ...
                            <!-- <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="#">Add</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div> -->
   ...
   $result=mysqli_query($join,"select*from student_info");
?>
                                   ...
                                   //         $sn=1;
                                       ...
                                       //         ?>
                                            ...
                                            <tr>
                                                ...
                                                <input name="id" type="hidden" id="id"; value="<?php echo $rows['id'];?>">
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="update.php?id=<?php echo $rows['id'];?>">Update<!--input type="submit" name="submit" value="Update"--></a></td>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Kilachand Devchand Polytechnic, Patan.</div>
                            <div>
